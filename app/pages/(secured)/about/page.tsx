     ...
     <section className='sm:w-full mt-20'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 justify-center items-center'>
                    ...
                    <section>
                        ...
                        <p className='text-white mx-3 mr-8 px-10 leading-8 sm:text-justify text-sm'>Welcome to ClearTek, where innovation meets excellence in software development. 
                            We are a team of passionate professionals dedicated to helping small technology businesses thrive in today&pos;s digital 
                            landscape. </p>
                    </section>
            ...
            <div className='w-full '>
              <div className='md:w-[1200px] mx-auto py-3'>
                ...
                <p className='text-white text-xl leading-10 sm:text-justify ml-1  px-10'>Whether you&apos;re a startup looking to build a groundbreaking application or an established business in need of digital transformation, we&pos;re here to help. Contact us today to learn more about how we can help your business succeed.</p>
              </div>
            </div>
        </section>
  )
